...
| 02 | [Runtime Trampoline And Alignment](02-runtime-trampoline-and-alignment.md) | How the thin `SKILL.md` loader keeps the agent inside `skill.spec.yml`, then uses `plan`, `act`, progress evidence, and compact `trace align --summary` as an OODA loop. |
