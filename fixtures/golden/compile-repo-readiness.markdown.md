...
- Alignment proof rows may be batched through `<run_dir>/final-proof.jsonl`; use the grouped proof digest as a checklist and record real evidence once with `skillspec progress batch`.
